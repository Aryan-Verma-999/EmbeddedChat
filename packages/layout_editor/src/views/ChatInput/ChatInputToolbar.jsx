  ...
  const options = useMemo(() => {
    return {
      ...
      ai: {
        ...
        visible: Boolean(
          publishedConfiguration?.placements.includes('composer')
        ),
      },
    };
  ...
  return (
    ...
    >
      <Box
        ...
        className="ec-chat-input-formatting-toolbar"
      >
        ...
        {aiOpen && publishedConfiguration?.placements.includes('composer') && (
          <GeneratedUiSurface
            open
